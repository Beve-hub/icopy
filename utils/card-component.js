        ...
        <div class="card m-3 position-relative" style="width: auto; color: white;  cursor:pointer; ">
            <div class="card-body">
                ...
                <ul class="list-group list-group-flush" style="background-color: transparent;">
                   ${card.offers.map(offer => `<li class="list-group-item " style="background-color: transparent; color: white; font-size: 0.8rem;"><i class="bi bi-check" style="color: green;"></i> ${offer}</li>`).join('')} 
                </ul>
                <button style="background-color: #D4FF27; color: #121212;  margin:10px 0; display:flex; align-items:center; justify-content:center; width: 100%;">Fund</button>
            </div>
        </div>
    `;
